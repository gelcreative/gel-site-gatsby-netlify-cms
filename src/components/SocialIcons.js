...
const SocialIcons = class extends Component {
  componentDidMount() {
    const socialListItems = Array.from(
      document.querySelectorAll('.gel-social-item'),
    );
  ...
  render() {
    return (
      <SocialIconList className="socialicons">
        ...
        <li className="gel-social-item">
          <a
            href="https://www.facebook.com/gelagency"
            target="_blank"
            rel="noopener noreferrer"
            title="Gel on Facebook"
          >
            <Facebook />
          </a>
        </li>
        <li className="gel-social-item">
          <a
            href="https://twitter.com/gelcreative"
            target="_blank"
            rel="noopener noreferrer"
            title="Gel on Twitter"
          >
            <Twitter />
          </a>
        </li>
        <li className="gel-social-item">
          <a
            href="https://www.linkedin.com/company/gel-creative/?originalSubdomain=ca"
            target="_blank"
            rel="noopener noreferrer"
